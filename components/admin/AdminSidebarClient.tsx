...
export function AdminSidebarClient({
  ...
  return (
    <aside
      className={`relative sticky top-0 flex hidden h-screen flex-shrink-0 flex-col border-r border-neutral-800/60 bg-neutral-950/95 shadow-2xl backdrop-blur-xl transition-all duration-300 ease-in-out md:flex ${isCollapsed ? "w-20" : "w-64"}`}
    >
      {/* Collapse Toggle */}
      <button
